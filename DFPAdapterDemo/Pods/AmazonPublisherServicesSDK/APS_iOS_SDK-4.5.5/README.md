# Amazon Publisher Services SDK (v4.5.5)
...
target 'iOSSampleApp' do
  pod 'AmazonPublisherServicesSDK', '4.5.5'
end
```
...
target 'iOSSampleApp' do
  pod 'AmazonPublisherServicesSDK', '4.5.5'
  pod 'AmazonPublisherServicesAdMobAdapter', '2.2.0'
end
```
...
target 'iOSSampleApp' do
  pod 'AmazonPublisherServicesSDK', '4.5.5'
  pod 'AmazonPublisherServicesMoPubAdapter', 'MOPUB_ADAPTER_VERSION'
end
```
