...
class AppsfireViewController: UIViewController , MNGAdsAdapterBannerDelegate,MNGAdsAdapterRefreshDelegate, MNGAdsAdapterNativeDelegate, MNGAdsAdapterInterstitialDelegate , MNGClickDelegate {
    ...
    @IBAction func createHimono(_ sender: UIButton) {
        ...
        bannerFactory?.placementId = "/\(MNG_ADS_APP_ID!)\( DemoSwiftConstants.PLACEMENTS_AppsFire.MNG_ADS_BANNER_PLACEMENT_ID)"
    ...
    @IBAction func createSashimi(_ sender: UIButton) {
        ...
        bannerFactory?.clickDelegate = self
        bannerFactory?.viewController = self
        bannerFactory?.placementId = "/\(MNG_ADS_APP_ID!)\( DemoSwiftConstants.PLACEMENTS_AppsFire.MNG_MAS_SQUARE_BANNER_PLACEMENT_ID)"
    ...
    @IBAction func createNativeAd(_ sender: UIButton) {
        ...
        nativeAdFactory?.placementId = "/\(MNG_ADS_APP_ID!)\(    DemoSwiftConstants.PLACEMENTS_AppsFire.MNG_ADS_NATIVEAD_PLACEMENT_ID)"
    ...
    @IBAction func createInterstitial(_ sender: Any) {
        ...
        interstitialAdsFactory?.placementId = "/\(MNG_ADS_APP_ID!)\(DemoSwiftConstants.PLACEMENTS_AppsFire.MNG_ADS_INTERSTITIAL_PLACEMENT_ID)"
