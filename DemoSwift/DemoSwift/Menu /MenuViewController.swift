...
class MenuViewController: UIViewController {
    ...
    @IBAction func openDFPDemoViewController(_ sender: UIButton) {
        APP_DELEGATE.drawerViewController?.closeMenu()
        let dfpVC  = DFPDemoViewController()
        APP_DELEGATE.appDelegateNavigationController?.setViewControllers([dfpVC], animated: false)
    }
